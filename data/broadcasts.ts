...
export const NEWS_BROADCASTS: Record<number, NewsBroadcast> = {
  10: {
    id: 'news10',
    url: 'https://res.cloudinary.com/dgvkbrgre/video/upload/v1758255289/noti19_gabriel_esjdge.mp3',
  ...
  12: {
    id: 'news12',
    url: 'https://res.cloudinary.com/dgvkbrgre/video/upload/v1758254890/noti_19_grace_patkec.mp3',
