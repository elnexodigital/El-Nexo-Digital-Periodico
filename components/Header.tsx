...
import type { MusicTrack, HeaderControls } from '../types';
...
const MUSIC_TRACKS: MusicTrack[] = [
  ...
  {
    id: 'm128',
    url: 'https://res.cloudinary.com/dgvkbrgre/video/upload/v1756154286/RAJA_-_Maasai_mk8k2k.mp3',
  ...
  {
    id: 'm172',
    url: 'https://res.cloudinary.com/dgvkbrgre/video/upload/v1756425528/LA_TRAMPA_CA%C3%8DA_LIBRE_tn4ia6.mp3',
...
const Header = forwardRef<HeaderControls, HeaderProps>(({ theme, toggleTheme }, ref) => {
  ...
  const togglePlayPause = () => {
    ...
    if (greetingAudioRef.current && greetingAudioRef.current.currentTime > 0 && !greetingAudioRef.current.ended) {
      greetingAudioRef.current.play().catch(e => {
        console.error("Error resuming greeting", e);
        setIsPlaying(false);
      });
      return;
    }
    ...
    <header className="text-center relative">
      ...
      <div className="my-4 overflow-hidden border-b-4 border-double border-stone-800 dark:border-stone-500 header-video-banner">
        <video
          ...
          aria-hidden="true"
        />
        <div className="z-10 flex justify-center items-center gap-3 bg-black/30">
          <audio
            ref={audioRef}
